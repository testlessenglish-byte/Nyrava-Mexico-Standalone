        ...
        <div className="panel p-8">
          <div className="flex flex-col items-center">
            ...
            <p className="mt-2 text-center text-sm text-muted-foreground">
              {mode === "signin" ? "Accede a tu Legal Intelligence OS." : "Configura tu espacio de trabajo México."}
            </p>
          </div>
          ...
          <div className="mt-6 flex items-center gap-3 text-[10px] uppercase tracking-[0.2em] text-muted-foreground">
            <div className="h-px flex-1 bg-border/60" /> o correo <div className="h-px flex-1 bg-border/60" />
          </div>
