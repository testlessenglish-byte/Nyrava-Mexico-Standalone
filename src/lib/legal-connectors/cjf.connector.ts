// CJF (Consejo de la Judicatura Federal) connector — STUB ONLY.
//
// Per NLKN build discipline: this is architecture, not a working fetch
// implementation. Nobody on this build has inspected CJF's actual site
...
//
// To activate: inspect https://www.cjf.gob.mx (or its known open-data
// pages, if any) from an environment with real network access, document
...
const NOT_IMPLEMENTED =
  "cjf.connector.ts is a stub — CJF's real endpoint/data shape has not been inspected yet. See file header.";

export const cjfConnector: LegalSourceConnector = {
  code: "cjf",
  displayName: "Consejo de la Judicatura Federal",
  kind: "court_decision",
  ...
  async healthCheck(): Promise<ConnectorHealth> {
    return { connectorCode: "cjf", ok: false, checkedAt: new Date().toISOString(), detail: "stub — not implemented" };
  },
};
