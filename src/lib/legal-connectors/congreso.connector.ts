// Congreso de la Unión connector — STUB ONLY.
//
// Per NLKN build discipline: this is architecture, not a working fetch
// implementation. Nobody on this build has inspected Congreso de la Unión's actual site
...
//
// To activate: inspect https://www.diputados.gob.mx / https://www.senado.gob.mx (legislative activity, iniciativas, reformas)
...
const NOT_IMPLEMENTED =
  "congreso.connector.ts is a stub — Congreso de la Unión's real endpoint/data shape has not been inspected yet. See file header.";
...
export const congresoConnector: LegalSourceConnector = {
  ...
  async healthCheck(): Promise<ConnectorHealth> {
    return { connectorCode: "congreso", ok: false, checkedAt: new Date().toISOString(), detail: "stub — not implemented" };
  },
};
