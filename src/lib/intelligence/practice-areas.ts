...
const PRACTICE_BLOCKED_TERMS: Record<PracticeArea, string[]> = {
  ...
  general_civil: [
    // US common-law procedural terms that must never appear in Nyrava MX civil output
    "miranda",
    "brady violation",
    "search and seizure",
    "indictment",
...
export const PRACTICE_AREA_LABELS: Record<PracticeArea, string> = {
  ...
  civil_rights: "Derechos Humanos (violaciones por autoridad)",
  general_civil: "Derecho Civil",
  personal_injury: "Responsabilidad Civil (daños y perjuicios)",
  medical_malpractice: "Responsabilidad Médica",
  employment: "Derecho Laboral",
  family: "Derecho Familiar",
  appellate: "Apelación / Segunda Instancia",
  tax_law: "Derecho Fiscal",
  corporate: "Derecho Corporativo / Societario",
  commercial: "Derecho Mercantil",
  ip: "Propiedad Intelectual",
  real_estate: "Derecho Inmobiliario",
  estate: "Sucesiones y Herencias",
  securities: "Derecho Bursátil",
  banking: "Derecho Bancario",
...
export const CASE_TYPE_SELECT_GROUPS: CaseTypeSelectGroup[] = [
  {
    ...
    options: [
      { value: "general_civil", label: "Derecho Civil" },
      { value: "personal_injury", label: "Responsabilidad Civil (daños y perjuicios)" },
      { value: "medical_malpractice", label: "Responsabilidad Médica" },
      { value: "employment", label: "Derecho Laboral" },
      { value: "family", label: "Derecho Familiar" },
      { value: "appellate", label: "Apelación / Segunda Instancia" },
    ],
  },
  {
    group: "Fiscal",
    options: [{ value: "tax_law", label: "Derecho Fiscal (auditoría, controversias, defraudación fiscal)" }],
  },
  {
    group: "Corporativo y Mercantil",
    options: [
      { value: "corporate", label: "Derecho Corporativo / Societario (gobierno corporativo, fusiones y adquisiciones)" },
      { value: "commercial", label: "Derecho Mercantil (contratos, actos de comercio)" },
      { value: "ip", label: "Propiedad Intelectual (marcas, patentes, derechos de autor, secretos industriales)" },
      { value: "real_estate", label: "Derecho Inmobiliario (compraventa, arrendamiento)" },
      { value: "estate", label: "Sucesiones y Herencias (testamentos, tutela)" },
      { value: "securities", label: "Derecho Bursátil" },
      { value: "banking", label: "Derecho Bancario" },
      { value: "fintech", label: "Tecnología Financiera (pagos, activos digitales)" },
    ],
  },
  {
    group: "Penal y Derechos Humanos",
    options: [
      { value: "criminal", label: "Derecho Penal" },
      { value: "civil_rights", label: "Derechos Humanos (violaciones por autoridad)" },
    ],
  },
  {
